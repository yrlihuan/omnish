...
- **TaskManager 与定时任务**：基于 tokio-cron-scheduler 的集中式任务管理器，内置任务：eviction、hourly_summary、daily_notes（基于 hourly summaries 汇总）、disk_cleanup、thread_summary、auto_update、plugin_bundle；均使用 SharedLlmBackend
